...
public class Add_Paid_Fee_Record extends JFrame {

    public Add_Paid_Fee_Record(JTable table) {
        // creates a new Jpanel//
        JPanel p1 = new JPanel();
        setTitle("Add Paid Fees Record");
        setSize(900, 700);
        setLocation(250, 20);
        setVisible(true);
        ...
        JLabel lb = new JLabel("Add Paid Fees Record Page");
        JLabel lb1 = new JLabel("Paid ID");
        JLabel lb2 = new JLabel("Tuition Fee Paid");
        JLabel lb3 = new JLabel("Pocket Money Paid");
        JLabel lb4 = new JLabel("Caution Money Paid");
        JLabel lb5 = new JLabel("Student ID");
        JTextField txt1 = new JTextField("Fees ID");
        JTextField txt2 = new JTextField("Tuition Fee Paid");
        JTextField txt3 = new JTextField("Pocket Money Paid");
        JTextField txt4 = new JTextField("Caution Money Paid");
      ...
      //  lb6.setForeground(new Color(0,96,169));
        ...
        txt2.addFocusListener(new FocusListener() {
            public void focusGained(FocusEvent e) {
                if (txt2.getText().trim().equals("Tuition Fee Paid")) {
                    txt2.setText("");
                }
            }
            ...
            public void focusLost(FocusEvent e) {
                if (txt2.getText().trim().equals("")) {
                    txt2.setText("Tuition Fee Paid");
                }
            }
        });
        txt3.addFocusListener(new FocusListener() {
            public void focusGained(FocusEvent e) {
                if (txt3.getText().trim().equals("Pocket Money Paid")) {
                    txt3.setText("");
                }
            }
            ...
            public void focusLost(FocusEvent e) {
                if (txt3.getText().trim().equals("")) {
                    txt3.setText("Pocket Money Paid");
                }
            }
        });
        ...
        txt4.addFocusListener(new FocusListener() {
            public void focusGained(FocusEvent e) {
                if (txt4.getText().trim().equals("Caution Money Paid")) {
                    txt4.setText("");
                }
            }
            ...
            public void focusLost(FocusEvent e) {
                if (txt4.getText().trim().equals("")) {
                    txt4.setText("Caution Money Paid");
                }
            }
        });
        ...
        Jb.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (!txt1.getText().equalsIgnoreCase("Product Name") && !txt2.getText().equalsIgnoreCase("{Product Registration")
                    ...
                    try {
                        addStudentPaid(txt1.getText(), txt2.getText(), txt3.getText(), txt4.getText(), txt5.getText(), table);
                    } catch (ClassNotFoundException ex) {
                        Logger.getLogger(Add_Student_Record.class.getName()).log(Level.SEVERE, null, ex);
                    } catch (SQLException ex) {
                        Logger.getLogger(Add_Student_Record.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void addStudentPaid(String txt1, String txt2, String txt3, String txt4, String txt5, JTable table) throws ClassNotFoundException, SQLException {
        ...
        stmt.executeUpdate("INSERT INTO fees_paid (paid_id,tutionfee_paid,pocketmoney_paid,cautionmoney_paid,student_id)"
                + " Values (" + txt1 + ",'" + txt2 + "','" + txt3 + "','" + txt4 + "'," + txt5 + ")");
        Display_Paid_Fee view = new Display_Paid_Fee();
        connection.close();
    }
